...
**🛡️ [GUARDIAN](https://github.com/andresguerra321/GUARDIAN)** — Sistema de seguridad predictiva para transporte terrestre con Computer Vision e IA colaborativa. Hackathon Voxel51 2026.
`Python` `FiftyOne` `Gemini AI` `Computer Vision`

<br/>

**🤖 DeliveryBot** — Terminal de pedidos automatizada integrando Telegram y n8n para gestión de entregas en tiempo real.
`Node.js` `n8n` `Telegram`

<br/>

**💬 WhatsApp Bot** — Asistente IA con memoria de conversación y personalidad de agente de ventas. Desplegado en Hugging Face.
`Baileys` `Groq` `Docker` `LLaMA`
